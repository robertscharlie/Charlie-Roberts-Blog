...
A small collection of games built with Pygame while learning Python and game development — each one a way to practice a different concept: sprite groups, collision detection, grid logic, and simple physics.
